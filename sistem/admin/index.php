...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Sistem Informasi Pengaduan Tenaga Kerja</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="" class="logo">
          ...
          <span class="logo-mini"><b>SP</b> ZP</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Sistem&nbsp;</b> Pengaduan</span>
        </a>
      ...
      <li><a href='?module=keluhan'><i class="fa fa-folder"></i> <span>Keluhan</span></a></li>
      <li><a href='module/fpdf/pdf.php'><i class="fa fa-print"></i> <span>Laporan Keluhan</span></a></li>
      <li><a href='module/fpdf/pdf.php'><!-- <i class="fa fa-print"></i> --> <span>ITsna</span></a></li>
			<li class="treeview">
			 <a href="#">
                <i class="fa fa-tasks"></i> <span>Data Master</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
			<ul class="treeview-menu">
				<li><a href='?module=jenis_peng' ><i class="fa fa-file"></i><span>Jenis Pengaduan</span></a></li>
				<li><a href='?module=unit_krj' ><i class="fa fa-institution"></i><span>Perusahaan</span></a></li>
								<li><a href='?module=penyidik' ><i class="fa fa-street-view"></i><span>Penyidik</span></a></li>
      ...
      <div style="background:url(../images/0.png)repeat;" class="content-wrapper">
        ...
        <section  class="content-header">
          <h1> Sistem Informasi Pengaduan Tenaga Kerja
            <small>Disnaker Kota Malang</small>
          </h1>
          <ol class="breadcrumb">
	...
	<?php include "isi.php";?>        		
      ...
      <footer class="main-footer">
        <div class="pull-right hidden-xs">
          Sistem Informasi Pengaduan Disnaker Kota Malang <b>Version</b> 1.0
        </div>
        <strong>Copyright PKL UIN Malang.
