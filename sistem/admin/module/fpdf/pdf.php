...
$sql=mysql_query("SELECT * FROM keluhan ORDER BY id_keluhan");
$data = array();
...
$judul = "DATA KELUHAN/PENGADUAN TENAGA KERJA";
$header = array(
array("label"=>"ID", "length"=>30, "align"=>"L"),
array("label"=>"Nama Pengadu", "length"=>50, "align"=>"L"),
array("label"=>"Nama Perusahaan", "length"=>30, "align"=>"L"),
array("label"=>"Ket Pengaduan", "length"=>30, "align"=>"L"),
array("label"=>"Jenis Pengaduan", "length"=>30, "align"=>"L"),
array("label"=>"Nama Penyidik", "length"=>30, "align"=>"L"),
