...
<h3 class="box-title margin text-center">Data Master Perusahaan</h3>
...
$sql ="SELECT max(id_unit_krj) as terakhir from unit_krj";
  ...
  $nextID = "PER".sprintf("%03s",$nextNoUrut);
?> 
  ...
  <div class="form-group">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" required="required" name="lokasi" placeholder="Lokasi">
    </div>
...
?>
	...
	<td><?php echo $tampilkan['lokasi']; ?></td> 
	<td align="center">
...
<h3 class="box-title margin text-center">Edit Data Perusahaan "<?php echo $_GET['id_unit_krj']; ?>"</h3>
<br/>
<form class="form-horizontal" action="<?php echo $aksi?>?module=unit_krj&aksi=edit" role="form" method="post">             
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    <label class="col-sm-4 control-label">Lokasi</label>
    <div class="col-sm-5">
      <input type="text" class="form-control" required="required" name="lokasi"value="<?php echo $edit['lokasi']; ?>">
    </div>
  </div>
